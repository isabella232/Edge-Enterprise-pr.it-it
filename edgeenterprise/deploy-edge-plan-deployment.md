...
> [!TIP]
> Usa gli strumenti di [individuazione di siti aziendali](https://docs.microsoft.com/internet-explorer/ie11-deploy-guide/collect-data-using-enterprise-site-discovery?redirectedfrom=MSDN) per individuare i siti che potrebbero necessitare della modalità Internet Explorer. Puoi raccogliere dati nei computer che eseguono le versioni da Windows Internet Explorer 8 a Internet Explorer 11 in Windows10, Windows8.1 o Windows7.
