...
## Assicurati che i dispositivi Windows 10 siano pronti
...
## Determina la metodologia per la distribuzione
...
### Distribuzione agli utenti finali per ruolo
...
### Distribuzione agli utenti finali per sito
...
## Esegui l'individuazione dei siti
...
### Se hai già distribuito e configurato la versione legacy di Microsoft Edge
...
### Se hai configurato Internet Explorer come browser predefinito
...
> [!TIP]
> Usa gli strumenti di [individuazione di siti aziendali](https://docs.microsoft.com/internet-explorer/ie11-deploy-guide/collect-data-using-enterprise-site-discovery?redirectedfrom=MSDN) per individuare i siti che potrebbero necessitare della modalità Internet Explorer. Puoi raccogliere dati nei computer che eseguono le versioni da Windows Internet Explorer 8 a Internet Explorer 11 in Windows 10, Windows 8.1 o Windows 7.

### Analisi dei dati di individuazione dei siti
...
## Determina la strategia del canale

Microsoft Edge viene rilasciato in [più canali](https://docs.microsoft.com/DeployEdge/microsoft-edge-channels).
...
## Definizione e configurazione dei criteri
...
Per prima cosa, valuta l'esperienza della prima esecuzione che desideri far sperimentare agli utenti. Se vuoi importare automaticamente le impostazioni dal browser corrente, configura i criteri per [AutoImportAtFirstRun](https://docs.microsoft.com/DeployEdge/microsoft-edge-policies#autoimportatfirstrun)
...
Per altri criteri, si consiglia di esaminare le configurazioni dei criteri per [Microsoft Edge](https://docs.microsoft.com/deployedge/microsoft-edge-policies) e gli [aggiornamenti di Microsoft Edge](https://docs.microsoft.com/deployedge/microsoft-edge-update-policies).

### Definizione dei criteri e della strategia di aggiornamento
...
- **Aggiorna Microsoft Edge al tuo ritmo**. Se preferisci controllare esplicitamente quando vengono distribuiti gli aggiornamenti, puoi disabilitare gli aggiornamenti automatici e distribuirli manualmente (vedi la [Guida di riferimento per i criteri degli aggiornamenti](https://docs.microsoft.com/DeployEdge/microsoft-edge-update-policies)). Dopo aver disabilitato gli aggiornamenti automatici, è possibile distribuire gli aggiornamenti per ciascun canale utilizzando uno degli strumenti seguenti:
...
## Esegui test di compatibilità delle app
...
## Convalida la tua distribuzione
...
## Ampia distribuzione di Microsoft Edge
