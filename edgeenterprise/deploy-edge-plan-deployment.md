...
###  <a name="if-you've-already-deployed-and-configured-the-legacy-version-of-microsoft-edge"></a>Se hai già distribuito e configurato la versione legacy di Microsoft Edge
...
###  <a name="if-you've-configured-internet-explorer-as-your-default-browser"></a>Se hai configurato Internet Explorer come browser predefinito
