...
ms.locfileid: "11325906"
---
# <span data-ttu-id="1b157-103">Criteri: Microsoft Edge WebView2</span><span class="sxs-lookup"><span data-stu-id="1b157-103">Microsoft Edge WebView2 - Policies</span></span>
...
## <span data-ttu-id="1b157-108">Criteri disponibili</span><span class="sxs-lookup"><span data-stu-id="1b157-108">Available policies</span></span>
...
### [*<span data-ttu-id="1b157-112">Impostazioni di override del caricatore</span><span class="sxs-lookup"><span data-stu-id="1b157-112">Loader Override Settings</span></span>*](#loader-override-settings-policies)
...
|[<span data-ttu-id="1b157-117">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="1b157-117">ReleaseChannelPreference</span></span>](#releasechannelpreference)|<span data-ttu-id="1b157-118">Imposta la preferenza dell'ordine di ricerca del canale di rilascio</span><span class="sxs-lookup"><span data-stu-id="1b157-118">Set the release channel search order preference</span></span>|
  ...
  ## <span data-ttu-id="1b157-119">Criteri delle impostazioni di override del caricatore</span><span class="sxs-lookup"><span data-stu-id="1b157-119">Loader Override Settings policies</span></span>
  ...
  ### <span data-ttu-id="1b157-121">BrowserExecutableFolder</span><span class="sxs-lookup"><span data-stu-id="1b157-121">BrowserExecutableFolder</span></span>

  #### <span data-ttu-id="1b157-122">Configura il percorso della cartella eseguibile del browser</span><span class="sxs-lookup"><span data-stu-id="1b157-122">Configure the location of the browser executable folder</span></span>

  
  
  #### <span data-ttu-id="1b157-123">Versioni supportate:</span><span class="sxs-lookup"><span data-stu-id="1b157-123">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="1b157-125">Descrizione</span><span class="sxs-lookup"><span data-stu-id="1b157-125">Description</span></span>
...
<span data-ttu-id="1b157-128">Per impostare il valore per il percorso della cartella, specifica il Nome del valore e la Coppia valori.</span><span class="sxs-lookup"><span data-stu-id="1b157-128">To set the value for the folder path, provide a Value name and Value pair.</span></span> <span data-ttu-id="1b157-129">Imposta il nome del valore sull'ID modello utente dell'applicazione o sul nome del file eseguibile.</span><span class="sxs-lookup"><span data-stu-id="1b157-129">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="1b157-130">È possibile usare il carattere jolly "\*" come nome del valore da applicare a tutte le applicazioni.</span><span class="sxs-lookup"><span data-stu-id="1b157-130">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="1b157-131">Funzionalità supportate:</span><span class="sxs-lookup"><span data-stu-id="1b157-131">Supported features:</span></span>
  ...
  #### <span data-ttu-id="1b157-135">Tipo:</span><span class="sxs-lookup"><span data-stu-id="1b157-135">Data Type:</span></span>
  ...
  #### <span data-ttu-id="1b157-137">Informazioni e impostazioni di Windows</span><span class="sxs-lookup"><span data-stu-id="1b157-137">Windows information and settings</span></span>

  ##### <span data-ttu-id="1b157-138">Info su Criteri di gruppo (ADMX)</span><span class="sxs-lookup"><span data-stu-id="1b157-138">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="1b157-144">Impostazioni del Registro di sistema di Windows</span><span class="sxs-lookup"><span data-stu-id="1b157-144">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="1b157-149">Valore di esempio</span><span class="sxs-lookup"><span data-stu-id="1b157-149">Example value:</span></span>
...
```
  ...
  ### <span data-ttu-id="1b157-151">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="1b157-151">ReleaseChannelPreference</span></span>

  #### <span data-ttu-id="1b157-152">Imposta la preferenza dell'ordine di ricerca del canale di rilascio</span><span class="sxs-lookup"><span data-stu-id="1b157-152">Set the release channel search order preference</span></span>

  
  
  #### <span data-ttu-id="1b157-153">Versioni supportate:</span><span class="sxs-lookup"><span data-stu-id="1b157-153">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="1b157-155">Descrizione</span><span class="sxs-lookup"><span data-stu-id="1b157-155">Description</span></span>
...
<span data-ttu-id="1b157-158">Per impostare il valore per la preferenza del canale di rilascio, specifica il Nome del valore e la Coppia valori.</span><span class="sxs-lookup"><span data-stu-id="1b157-158">To set the value for the release channel preference, provide a Value name and Value pair.</span></span> <span data-ttu-id="1b157-159">Imposta il nome del valore sull'ID modello utente dell'applicazione o sul nome del file eseguibile.</span><span class="sxs-lookup"><span data-stu-id="1b157-159">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="1b157-160">È possibile usare il carattere jolly "\*" come nome del valore da applicare a tutte le applicazioni.</span><span class="sxs-lookup"><span data-stu-id="1b157-160">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="1b157-161">Funzionalità supportate:</span><span class="sxs-lookup"><span data-stu-id="1b157-161">Supported features:</span></span>
  ...
  #### <span data-ttu-id="1b157-165">Tipo:</span><span class="sxs-lookup"><span data-stu-id="1b157-165">Data Type:</span></span>
  ...
  #### <span data-ttu-id="1b157-167">Informazioni e impostazioni di Windows</span><span class="sxs-lookup"><span data-stu-id="1b157-167">Windows information and settings</span></span>

  ##### <span data-ttu-id="1b157-168">Info su Criteri di gruppo (ADMX)</span><span class="sxs-lookup"><span data-stu-id="1b157-168">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="1b157-174">Impostazioni del Registro di sistema di Windows</span><span class="sxs-lookup"><span data-stu-id="1b157-174">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="1b157-179">Valore di esempio</span><span class="sxs-lookup"><span data-stu-id="1b157-179">Example value:</span></span>
...
## <span data-ttu-id="1b157-181">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="1b157-181">See also</span></span>
